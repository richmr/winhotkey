...
def run(hotkey_prefix: Annotated[str, typer.Option(help="'keyboard' compatible hot key prefix'")] = "ctrl+alt",
    ...
    In case your 'phrases' are sensitive, you will not see what you enter\n
    ...
    for entry in possible_entries:
        ...
        phrase = typer.prompt(f"Please enter phrase for '{key}'", hide_input=True, default="Press Enter when done")
